...
func (a *LocalKeyAgent) AddTrustedCerts(certAuthorities []auth.TrustedCerts) error {
	return a.keyStore.AddTrustedCerts(a.proxyHost, certAuthorities)
}
...
func (a *LocalKeyAgent) checkHostCertificateForClusters(clusters ...string) func(key ssh.PublicKey, addr string) bool {
	return func(key ssh.PublicKey, addr string) bool {
		...
		keys, err := a.keyStore.GetKnownHostKeys(clusters...)
		if err != nil {
...
func (a *LocalKeyAgent) checkHostKey(addr string, remote net.Addr, key ssh.PublicKey) error {
	...
	err = addTrustedHostKeys(a.keyStore, a.proxyHost, addr, key)
	if err != nil {
