...
---
  ...
  - [Joining Nodes via Kubernetes ServiceAccount Token](./guides/joining-nodes-kubernetes-serviceaccount.mdx).
    Use Kubernetes ServiceAccount tokens to join Nodes running in the same Kubernetes cluster than the Auth Service.
  </ScopedBlock>
