...
The upgrade should not require configuration changes. Make sure you don't rely on `standalone.storage` (if you do, switch to using `persistence` values instead)
...
#### If you only needed a couple of custom configuration overrides
