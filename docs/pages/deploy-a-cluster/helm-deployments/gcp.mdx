...
# pod/teleport-auth-0                   1/1     Running   0          7m16s
# pod/teleport-auth-1                   1/1     Running   0          7m16s
# pod/teleport-proxy-69c9c4c986-j9v2j   1/1     Running   0          7m16s
# pod/teleport-proxy-69c9c4c986-qhh5f   1/1     Running   0          7m16s
...
# service/teleport-auth   ClusterIP      10.40.15.135   <none>         3025/TCP,3026/TCP                                            7m16s

# NAME                             READY   UP-TO-DATE   AVAILABLE   AGE
# deployment.apps/teleport-proxy   2/2     2            2           7m16s

# NAME                                        DESIRED   CURRENT   READY   AGE
# replicaset.apps/teleport-proxy-b64dd8849    2         2         2       7m16s

# NAME                             READY   AGE
# statefulset.apps/teleport-auth   2/2     7m16s
```
