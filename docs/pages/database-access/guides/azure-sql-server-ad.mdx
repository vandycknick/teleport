...
## Step 3/8. Configure Azure Managed Identities
...
## Step 4/8. Enable managed identities login on SQL Server
...
## Step 5/8. Create a Database Service configuration
...
## Step 6/8. Configure IAM permissions for Teleport
...
identity check [Step 4](#step-38-configure-azure-managed-identities) to see how
to add it.
...
described in [Step 5](#step-48-enable-managed-identities-login-on-sql-server).
